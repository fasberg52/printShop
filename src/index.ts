// This index is a minimal aggregator to quickly import in your Nest app or tests.
export * from './modules/orders/schema/order.schema';
export * from './modules/payments/schema/payment.schema';
